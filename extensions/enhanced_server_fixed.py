#!/usr/bin/env python3
"""
Fixed Enhanced Google Ads MCP Server
Working version with proper MCP function signatures
"""
...
# Create server
server = Server("google-ads-enhanced-fixed")
...
async def list_tools():
    ...
    return [
        ...
        Tool(
            ...
            description="Create a Responsive Search Ad with multiple headlines and descriptions. Currently in development mode - validates but doesn't create real ads.",
            inputSchema={
                "type": "object",
                "properties": {
                    "customer_id": {
...
async def main():
    """Main entry point"""
    try:
        logger.info("Starting fixed Google Ads MCP server...")
